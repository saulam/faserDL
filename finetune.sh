...
head_init=2e-5
save_dir="logs_final"
name="finetune_v5.1b_dlnu_log_base_clariden_0_5_v11"
log_every_n_steps=10
save_top_k=1
checkpoint_path="checkpoints_final"
checkpoint_name="finetune_v5.1b_dlnu_log_base_clariden_0_5_v11"
...
load_checkpoint="checkpoints_final/pretrain_v5.1b_dlnu_log_base_clariden_0_5_v3/loss_val_total/epoch=247-step=89528.ckpt"
gpus=(1)
