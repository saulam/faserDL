...
def ini_argparse(
    ...
    parser.add_argument("--standardize_input", type=str, default=None, help="standarisation type to input (z-score / unit-var / norm)")
    parser.add_argument("--standardize_output", type=str, default=None, help="standarisation type to output (z-score / unit-var / norm)")
    ...
    parser.add_argument("-d", "--dataset_path", type=str, default=None, required=True, help="Dataset path")
    parser.add_argument("--extra_dataset_path", type=str, default=None, help="Path for an additional set to append to the training set")
